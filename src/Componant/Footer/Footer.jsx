...
export  function Footer() {
  ...
  <footer className={` mt-5 py-4`}>
    <div className={`${Style.footerStyle} mx-auto row`}>
      ...
      <li className='me-3'><Link className={`${Style.linkStyle} fs-6`} to="/Ahmed-Portfolio" >Home</Link></li>
...
<p  className='fs-6 text-center'>© 2024 Ahmed Adel. All rights reserved.</p>
</div>
